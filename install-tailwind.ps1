...
new-item tailwind.base.css, tailwind.utilities.css, tailwind.components.css | out-null
...
npx editpackagejson -k "dev:tw" -v '""cross-env NODE_ENV=development postcss ./tailwind/tailwind.main.css -o ./dist/css/tailwind.css""' --out-null
